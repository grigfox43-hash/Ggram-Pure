...
<p align="center">
  <b>Ggram Pure</b> — 100% полный официальный клиент Telegram для Android, собранный на базе кодовой базы <b>DrKLO/Telegram</b> со всеми возможностями оригинального мессенджера, встроенной блокировкой всей рекламы, мгновенным переводом сообщений и фирменной иконкой максимальной жирности <b>G</b> цвета <code>#01ba53</code> шрифтом <b>Playfair Bold</b> на фоне <code>#050505</code>.
</p>
...
### 🎨 4. Фирменная иконка максимальной жирности
- **Символ:** Однотонная заглавная буква **G**.
- **Шрифт:** **Playfair Bold** в **максимальной жирности** (Ultra-Black weight 900).
- **Цвет:** Фирменный неоновый изумрудный `#01ba53`.
- **Фон:** Глубокий обсидиановый черный `#050505`.
